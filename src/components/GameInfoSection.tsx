...
const GameInfoSection = () => {
  ...
  return (
    <article className="py-12 md:py-20 bg-gradient-card">
              ...
              {gameStats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <dd className="text-white text-xl font-bold">{stat.value}</dd>
                  </div>
                </div>
              ))}
            </dl>
            
            <aside className="mt-8 p-6 bg-gradient-button rounded-xl text-center">
              <h3 className="text-white font-bold text-lg mb-2">
                <span aria-hidden="true">🎯</span> Por que jogar Fortune Tiger?
              </h3>
